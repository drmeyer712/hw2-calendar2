...
class addEventFri: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        var DestViewController : Friday = segue.destinationViewController as! Friday
        friNames.append(eventTitle.text)

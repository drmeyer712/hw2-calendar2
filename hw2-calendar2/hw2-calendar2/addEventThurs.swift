...
var thursNames = [String]()

var thursEvents = [event]()

class addEventThurs: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        var DestViewController : Thursday = segue.destinationViewController as! Thursday
        thursNames.append(eventTitle.text)
